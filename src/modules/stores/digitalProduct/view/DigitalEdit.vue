...
export default {
  ...
  methods: {
      ...
      if(imageName){
        ...
        if (result) {
          ...
          try {
            ...
            const response = await fetch(this.url + 'api/v1/store/digitalstore/products/image/delete/'+this.$route.params.id, {
              method: 'POST',
              body: data,
              headers: {
    ...
    async requestApi() {
      ...
      try {
        let token = localStorage.getItem('token');
        const response = await fetch(this.url + 'api/v1/store/digitalstore/products/edit/'+this.$route.params.id, {
          method: 'POST',
          body: data,
          headers: {
            'Accept-Language': 'en-US,en;q=0.8',
        ...
        if (status == 401) {
          ...
          if (json.error) {
            ...
            this.resSuccess = 'Digital Store Product Successfully Updated';
          }
        }
    ...
    requestGetStore(){
          ...
          let newUrl = this.url+'api/v1/getStoresByType?type=digital';
    ...
    getStore(){
      let newUrl = this.url+'api/v1/store/digitalstore/products?product_id='+this.$route.params.id;
                    ...
                    if(data){
                      ...
                      this.amount = data.amount;
                        ...
                        try {
                          ...
                          this.banner_ru_prev.push(this.url+'files/digitalStoresProduct/'+element)
                          // console.log( JSON.parse(`${data.productIMG}`).isArray);
                        });
                        } catch (error) {
                        //  console.log(error);
                          this.banner_ru_prev =  this.url+'files/digitalStoresProduct/'+data.img;
                        }
