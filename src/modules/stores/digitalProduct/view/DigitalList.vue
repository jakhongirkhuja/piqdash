...
<template>
    <div class="row">
        <div class="col-md-3">
            ...
            <CrudButton  v-if="userInfo && (userInfo.role=='Creator' || userInfo.role=='Owner')" urlName="digitalProduct.add" :btnName="'Add Product'"  />
        </div>
        <div class="col-md-6">
...
export default {
    data() { 
        return {
            imageUrl : 'https://api.pharmiq.uz/files/digitalStoresProduct/',
            disabled: false,
            modelName:'',
            modelUserId:'',
            currentPage: 1,
    ...
    methods:{
       showImageUrl(url){
        ...
        showstore(store_id){
          this.$router.push({ name: 'digitalProduct.show', params: {'id': store_id}})
        },
        ...
        editstore(store_id){
            this.$router.push({ name: 'digitalProduct.edit', params: {'id': store_id}})
        },
        ...
        async requestApiDelete(){
            ...
            try {
              ...
              const response = await fetch(this.url+'api/v1/store/digitalstore/products/delete/'+this.modelUserId, {
              method: 'POST', // или 'PUT'
        ...
        requestApi(page, search=null){
          ...
          let newUrl = this.url+'api/v1/store/digitalstore/products?page='+page;
