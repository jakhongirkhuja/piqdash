...
<template>
    <div class="row">
        <div class="col-md-3">
            ...
            <CrudButton  v-if="userInfo && (userInfo.role=='Creator' || userInfo.role=='Owner')" urlName="korzinka.add" :btnName="'Add BarCode'"  />
        ...
        <div class="col-md-3 text-right">
          <span style="padding-top: 5px; text-decoration: underline;">Not Used:  <b>{{ notUsedBarCode }}</b></span>
                      ...
                      <div class="table-responsive">
                        ...
                        <tbody>
                            <tr v-for="market in markets" :key="market.id">
                               <td> {{market.barcode}}</td>
                               <td> {{market.facevalue.toLocaleString('ru-RU')}}</td>
                                <td class="actions">
                                     ...
                                     <div  data-toggle="modal" data-target="#exampleModal cursor-pointer" v-if="userInfo && (userInfo.role=='Creator' || userInfo.role=='Owner')" @click="openmodel(market.id, market.barcode)" class="delete text-danger" ><i class="ti ti-trash" data-toggle="tooltip" title="Edit"></i></div>
                                  </td>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body text-center">
        ...
        <h4>Are you sure you want to delete this Barcode?</h4>
        <h4>{{modelName}}</h4>
        
        <p>barcodeId: {{modelUserId}}</p>
      </div>
...
export default {
    ...
    methods:{
       showImageUrl(url){
        ...
        showstore(store_id){
          this.$router.push({ name: 'physicalStore.show', params: {'id': store_id}})
        },
        ...
        editstore(store_id){
            this.$router.push({ name: 'korzinka.edit', params: {'id': store_id}})
        },
        ...
        async requestApiDelete(){
            ...
            try {
              ...
              const response = await fetch(this.url+'api/v1/store/korzinkabarcode/delete/'+this.modelUserId, {
              method: 'POST', // или 'PUT'
        ...
        requestApi(page, search=null){
          ...
          let newUrl = this.url+'api/v1/store/korzinkabarcode?page='+page;
        ...
        requestApiEmptyBarCode(){
          
          let newUrl = this.url+'api/v1/store/korzinkabarcode/notUsed';
           ...
           const options = {
            ...
            fetch(newUrl, options)
                ...
                .then((data) => {
                    ...
                    this.notUsedBarCode = data.notUsedBarCode;
                });
        }
    },
    mounted() {
