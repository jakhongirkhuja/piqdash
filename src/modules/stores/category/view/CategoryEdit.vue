          ...
          <div class="card-body">
            ...
            <form class="forms-sample" @submit.prevent="submitForm()">
              <div class="form-group row">
                <div class="col-md-12">
                   <label for="exampleInputTypee">Global type</label>
                   <select v-model="storeCategoryTypeChoose" class="form-control">
  ...
  methods: {
    async requestApi() {
      ...
      const inputs = {
        ...
        'global_type': this.storeCategoryTypeChoose
      }
      ...
      if(this.banner_ru.length!=0){
        data.append('icon', this.banner_ru)
      }
      ...
      try {
        ...
        const response = await fetch(this.url + 'api/v1/store/category/edit/'+this.$route.params.id, {
          method: 'POST',
          body: data,
          headers: {
        ...
        if (status == 401) {
          ...
          if (json.error) {
            ...
            this.resSuccess = 'Store Category Successfully Updated';
          }
        }
    ...
    getStore(){
      let newUrl = this.url+'api/v1/store/category?category_id='+this.$route.params.id;
            ...
            fetch(newUrl, options)
                ...
                .then((data) => {
                    if(data){
                      ...
                      this.storeCategoryTypeChoose = data.global_type==true? 1 : 0;
                      this.banner_ru_prev = this.url+'files/storeCategory/'+data.icon;
                    }
