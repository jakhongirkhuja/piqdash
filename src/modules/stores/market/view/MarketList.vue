...
<template>
    <div class="row">
        <div class="col-md-3">
            ...
            <CrudButton  v-if="userInfo && (userInfo.role=='Creator' || userInfo.role=='Owner')" urlName="markets.add" :btnName="'Add Store'"  />
        </div>
        <div class="col-md-6">
                      ...
                      <div class="table-responsive">
                        ...
                        <tbody>
                            <tr v-for="market in markets" :key="market.id">
                                ...
                                <td>{{$i18n.locale=='ru'? JSON.parse(market.storeDescription).ru : JSON.parse(market.storeDescription).uz }}</td>
                                <td class="actions">
...
export default {
    ...
    methods:{
       showImageUrl(url){
        ...
        showstore(store_id){
          this.$router.push({ name: 'markets.show', params: {'id': store_id}})
        },
        ...
        editstore(store_id){
            this.$router.push({ name: 'markets.edit', params: {'id': store_id}})
        },
        ...
        async requestApiDelete(){
            ...
            try {
              ...
              const response = await fetch(this.url+'api/v1/store/delete/'+this.modelUserId, {
              method: 'POST', // или 'PUT'
        ...
        requestApi(page, search=null){
          ...
          let newUrl = this.url+'api/v1/store?page='+page;
