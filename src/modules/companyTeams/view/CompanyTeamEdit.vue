      ...
      fetch(newUrl, options)
        ...
        .then((data) => {
          if(data.companyTeams){
            console.log(data.company_team_address);
            this.title_ru = data.companyTeams.teamName;
            this.monetized = data.companyTeams.teamType;
            
            this.getvalue();
            if(data.companyTeams.company_team_address){
              this.city_id = data.companyTeams.company_team_address.city_id;
              this.region_id = data.companyTeams.company_team_address.region_id
              this.storeLandmark_ru = data.companyTeams.company_team_address.addressline;
              this.long = data.companyTeams.company_team_address.longitude;
              this.lat = data.companyTeams.company_team_address.latitude;
              this.getRegions(this.city_id, this.region_id);
            }
          }else{
