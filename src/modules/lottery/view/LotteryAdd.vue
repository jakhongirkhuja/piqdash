  ...
  <div class="mt-3">
    <div class="row">
      <div class="col-md-12 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            <h4 class="card-title">Add Lottery</h4>
            ...
            <form class="forms-sample" @submit.prevent="submitForm()">
              ...
              <button v-if="!added" type="submit" :disabled='isDisabled' class="btn btn-primary mr-2 mt-2">Create</button>
...
export default {
  ...
  methods: {
    ...
    async requestApi() {
      ...
      try {
        let token = localStorage.getItem('token');
        const response = await fetch(this.url + 'api/v1/lottery/add', {
          method: 'POST',
          body: data,
          headers: {
        ...
        if (status == 401) {
          ...
          if (json.error) {
            ...
            this.added = true;
            this.resSuccess = 'Lottery Successfully Added';
          }
        }
