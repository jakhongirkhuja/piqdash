                ...
                <div class="card-body">
                  ...
                  <form class="forms-sample" @submit.prevent="submitForm()">
                    ...
                    <div class="form-group">
                        ...
                        <option value="Creator" v-if="userInfo &&  userInfo.role=='Creator'">Creator</option>
                        <option value="Owner" v-if="userInfo &&  userInfo.role=='Creator'">Owner</option>
                        <option value="Store Owner" v-if="userInfo && (userInfo.role=='Creator' || userInfo.role=='Owner')">Store Owner</option>
                        <option value="Analytic" v-if="userInfo && (userInfo.role=='Creator' || userInfo.role=='Owner')">Analytic</option>
          ...
          try {
            ...
            if(status==401){
              ...
              console.log(typeof json.message == 'object');
                ...
                // this.$router.push({ name: 'users.edit', params: {'id': json.user.hrid}})
                this.resSuccess  = 'User Successfully Added ';
              }
            }
